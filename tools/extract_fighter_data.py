...
with out.open('a') as f:f.write('namespace sagas { inline constexpr unsigned guard_on_sfx='+str(voices['nSYAudioFGMGuardOn'])+',guard_off_sfx='+str(voices['nSYAudioFGMGuardOff'])+'; }\n')
