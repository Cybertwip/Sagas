...
for idx,name in enumerate(names):
 ...
 tilt=[ids.get('FT'+('Mario' if name=='Luigi' else name)+'Anim'+s,0) for s in ('FTiltHigh','FTiltMidHigh','FTilt','FTiltMidLow','FTiltLow','UTilt','DTilt')]
